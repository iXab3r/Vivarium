...
parameter names with repository and image-name defaults supplied by the DSL.
...
1. Run `Publish / Docker`; Cvat builds, smokes, and pushes the image without involving GitHub.
