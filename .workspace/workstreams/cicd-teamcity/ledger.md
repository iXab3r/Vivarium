...
| teamcity:pipeline-shape | Compile -> Release -> Publish | TeamCity | TeamCity Expert, Test Steward | three configurations validate locally; server import pending | one Compile counter and source revision stamp every RID; Release contains no compile/test step; Publish contains no packaging step |
