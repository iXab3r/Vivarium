...
without GitHub credentials. Tag Compile builds bake that SemVer into the binaries, and TeamCity snapshot
dependencies keep all four Compile outputs on the same revision. GitHub publication remains
